...
const headerProfile = ({ user, state, changeOption }) => {
    ...
    return (
        <div className="container-fluid pt-5 shadow-sm" style={{ backgroundColor: "white" }}>
            ...
            <div id="myDiv" className="d-flex justify-content-center mt-5">
               ...
               <img className={(state === 2 ? "actived" : "optionUser") + " mx-4 mb-3"} src="/images/account.png" style={{ width: 30, height: 30, cursor: "pointer"}} onClick={() => changeOption(2)} /> 
            </div>
        </div>
    )
}
